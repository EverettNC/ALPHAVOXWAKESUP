...
def adaptive_dashboard():
    ...
    complexity_levels = {
        i: complexity_engine.get_complexity_level_info(i) for i in range(1, 6)
    }
    adaptation_modes = {
...
def test_adaptation():
    ...
    simplified_complexity = complexity_engine._calculate_text_complexity(
        simplified_text
    )
    ...
    return jsonify(
        {
            ...
            "complexity_info": complexity_engine.get_complexity_level_info(
                int(target_complexity)
            ),
        }
    )
