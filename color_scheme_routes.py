...
def apply_color_scheme():
    ...
    try:
        ...
        return jsonify(
            {"success": True, "message": "Color scheme applied successfully"}
        )
    except Exception as e:
...
def apply_custom_scheme():
    ...
    try:
        ...
        UserPreference.set_preference(
            user_id, "color_scheme", custom_scheme_key, "manual"
        )
        ...
        return jsonify(
            {"success": True, "message": "Custom color scheme applied successfully"}
        )
    except Exception as e:
        logger.error(f"Error applying custom color scheme: {e}")
        return (
            jsonify(
                {"success": False, "message": "Error applying custom color scheme"}
            ),
            500,
        )
...
def save_accessibility_settings():
    ...
    try:
        ...
        return jsonify(
            {"success": True, "message": "Accessibility settings saved successfully"}
        )
    except Exception as e:
        logger.error(f"Error saving accessibility settings: {e}")
        return (
            jsonify(
                {"success": False, "message": "Error saving accessibility settings"}
            ),
            500,
        )
