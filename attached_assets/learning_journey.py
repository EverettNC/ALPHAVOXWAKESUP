...
class LearningJourney:
    ...
    def get_learning_summary(self, user_id: str) -> Dict[str, Any]:
        ...
        learning_velocity = len(user_events) / max(
            1,
            (
                datetime.datetime.now()
                - datetime.datetime.fromisoformat(
                    user_events[0]["timestamp"]
                    if user_events
    ...
    def get_learning_statistics(self, user_id: str) -> Dict[str, Any]:
        ...
        for event in user_events:
            date = (
                datetime.datetime.fromisoformat(event["timestamp"]).date().isoformat()
            )
        ...
        for topic in self.topics:
            ...
            events = [
                ...
                if e["event_type"] == "topic_explored"
            ...
            if events:
                ...
                progress = min(
                    1.0, len(events) / 5
                )  # Assume 5 interactions = 100% progress
