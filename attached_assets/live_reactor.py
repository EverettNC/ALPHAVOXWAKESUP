...
class LiveReactor:
    ...
    def process_live_input(
        self, gesture=None, eye=None, emotion=None
    ) -> Dict[str, Any]:
        """
        ...
        result = self.engine.process_multimodal_sequence(
            gesture_features=gesture, eye_features=eye, emotion_features=emotion
        )
...
def process_live_input(gesture=None, eye=None, emotion=None):
    ...
    result = reactor.process_live_input(gesture=gesture, eye=eye, emotion=emotion)
    return result
